...
export class WebhookService {
  ...
  constructor(private readonly parserService: ParserService, private readonly bookingService: BookingService) {}

  async handleReservation(payload: any) {
    ...
    this.bookingService.createBooking(intent);
